  ...
  return (
    <div className="min-h-screen bg-background flex">
      ...
      <div className="hidden lg:flex flex-1 items-center justify-center bg-secondary/30 relative overflow-hidden">
        ...
        >
          <div className="w-24 h-24 mx-auto mb-8 rounded-full bg-primary/20 flex items-center justify-center glow-gold">
          ...
          <p className="text-muted-foreground max-w-sm mx-auto">
            Continue where you left off, discover new recommendations, and track
